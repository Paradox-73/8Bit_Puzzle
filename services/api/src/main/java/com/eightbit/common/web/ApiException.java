...
/**
 * Application-level error carrying a machine-readable code (consumed by the frontend)
 * and an HTTP status. Throw this anywhere; {@link GlobalExceptionHandler} renders it.
 */
